...
const createRecord = async (req, res) => {
    ...
    try {
        ...
        // Branch Staff dates are always generated by PostgreSQL. Passing NULL
        // here prevents a client-provided date from reaching the insert.
        const effectiveRegistrationDate = isBranchStaff(req.user)
            ? null
            : registration_date;
